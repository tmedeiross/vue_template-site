    ...
    <div class="pushy-panel__inner">
      <header class="pushy-panel__header">
        <div class="pushy-panel__logo">
          <a href="index.html"><img src="static/images/soccer/logo.png" srcset="static/images/soccer/logo@2x.png 2x" alt="Alchemists"></a>
        </div>
      </header>
            ...
            <ul class="posts posts--simple-list">
              <li class="posts__item posts__item--category-1">
                <figure class="posts__thumb">
                  <a href="#"><img src="static/images/samples/post-img19-xs.jpg" alt=""></a>
                </figure>
        ...
        <aside class="widget widget--side-panel widget-banner">
          <div class="widget__content">
            <figure class="widget-banner__img">
              <a href="#"><img src="static/images/samples/banner.jpg" alt="Banner"></a>
            </figure>
          </div>
        </aside>
        <!-- Widget: Banner / End -->
