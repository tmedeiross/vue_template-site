      ...
      <div class="widget-game-result__section">
        <div class="widget-game-result__section-inner">
          <header class="widget-game-result__header">
            ...
            <time class="widget-game-result__date" datetime="2016-03-24">{{ gameResultDate }}</time>
          </header>
          ...
          <div class="widget-game-result__main">
            ...
            <div class="widget-game-result__team widget-game-result__team--first">
              <figure class="widget-game-result__team-logo">
                <a href="#"><img :src="gameResultTeamLogoFirst" alt=""></a>
              </figure>
              <div class="widget-game-result__team-info">
                <h5 class="widget-game-result__team-name">{{ gameResultTeamNameFirst }}</h5>
                <div class="widget-game-result__team-desc">{{ gameResultTeamDescFirst }}</div>
              </div>
            </div>
            <!-- 1st Team / End -->
            ...
            <div class="widget-game-result__score-wrap">
              <div class="widget-game-result__score">
                <span class="widget-game-result__score-result widget-game-result__score-result--winner">{{ gameResultScoreResultWinner }}</span>
                <span class="widget-game-result__score-dash">-</span>
                <span class="widget-game-result__score-result widget-game-result__score-result--loser">{{ gameResultScoreResultLoser }}</span>
              </div>
            ...
            <div class="widget-game-result__team widget-game-result__team--second">
              <figure class="widget-game-result__team-logo">
                <a href="#"><img :src="gameResultTeamLogoSecond" alt=""></a>
              </figure>
              <div class="widget-game-result__team-info">
                <h5 class="widget-game-result__team-name">{{ gameResultTeamNameSecond }}</h5>
                <div class="widget-game-result__team-desc">{{ gameResultTeamDescSecond }}</div>
              </div>
            </div>
            <!-- 2nd Team / End -->
          </div>
...
export default {
  ...
  name: 'post-card',
    ...
    gameResultTeamNameFirst: {
      type: String,
      required: true
    },
    gameResultTeamDescFirst: {
      type: String,
      required: true
    },
    gameResultTeamNameSecond: {
      type: String,
      required: true
    },
    gameResultTeamDescSecond: {
      type: String,
      required: true
    },
    gameResultScoreResultWinner: {
      type: String,
      required: true
    },
    gameResultScoreResultLoser: {
      type: String,
      required: true
    },
    gameResultTeamLogoFirst: {
      type: String,
      required: true
    },
    gameResultTeamLogoSecond: {
      type: String,
      required: true
    },
  }    
